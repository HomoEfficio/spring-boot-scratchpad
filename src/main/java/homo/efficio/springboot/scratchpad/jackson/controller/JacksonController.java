...
//    public ResponseEntity<SampleDTO> saveSampleEntityNotJSON(HttpServletRequest request, SampleDTO dto) {
...
//    }
    ...
    @RequestMapping(value = "/data-binder-util", method = RequestMethod.GET, consumes = MediaType.APPLICATION_JSON_UTF8_VALUE)
